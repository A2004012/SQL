...
(42,'aarav','jain',3,72000,'2024-01-02','aarav.jain@example.com');
...
insert into employees values 
(43,'Rahul','Mehra',11,58000,'2024-01-10','rahul.mehra@example.com'),
...
insert into employees values
(52,'Arjun','Shah',12,75000,'2024-04-01','arjun.shah@example.com'),
...
insert into employees values
(54,'Kavita','Desai',13,50000,'2024-05-01','kavita.desai@example.com'),
...
select * from employees
where salary > 55000 and dateofjoining < '2024-03-01';
...
select location, count(departmentid)
from departments
group by location;
...
select concat(departmentname,"  ",location) as complete_department_address
from departments;
...
-- number. 
select concat(departmentid," ",employeeid) as unique_employeeid from employees;
...
select concat(phonenumber) as contactlist from employee;

-- Situation -6: To display the complete address, concatenate the street, city, and postal code of 
-- each employee. 
select concat(city," ",postalcode) as complete_address;
...
update employees
set jobtitile = 'Senior developer'
